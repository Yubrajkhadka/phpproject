        ...
        <?php
            ...
            <div class="item py-1 bg-light">
                <div class="product font-rale">
                    <a href="product.php?product_id=<?php echo $item['id'];?>"><img src="./assets/products/<?php echo $item['image'] ??"./assets/products/default.png";?>" alt="" class="img-fluid mx-auto d-flex" style="height:200px; width:auto;object-fit:cover;"></a>
